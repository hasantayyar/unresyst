...
kod z konzole - build, recommend, predict
    ...
    \section{Applying Rules}
        ...
        \subsection{Combining}
            ...
            \begin{enumerate}
                \item If one element is positve and the other negative, the result should be neutral.
                \item If both elements are positive, the result should be more positive than both of the elements.
                \item If both elements are negative, the result should be more negative than both of the elements.
            \end{enumerate}
            
            For combining the combination elements we propose the functions described in the following subsections.
