...
\noindent Study Programm: Computer Science, Software Engineering % doplòte odpovídající údaje
%%% dal¹í øádek mù¾ete ve vìt¹inì pøípadù (tj. pokud údaje uvedené vý¹e nejsou pøíli¹ dlouhé) zru¹it
%\hskip20mm 
...
% format <lidi Prijmeni J., ...> (<rok>): <nazev>. <biblo kidy>. <url>
%\bibitem{lamport94}
...
%  ISBN 0-201-52983-1.
    \bibitem{last_fm}Last.fm recommendation service. Last.fm Ltd. \url{http://www.last.fm/about}
    
    \bibitem{probabilistic_analysis}Kumar R., Raghavan P. Tomkins A., Rajagopalan S. (1998):
Recommendation systems: a probabilistic analysis. 39th Annual Symposium on Foundations of Computer Science, ISBN: 0-8186-9172-7. \url{http://www.tomkinshome.com/site_media/papers/papers/KRR+98.pdf}

    \bibitem{collaborative_filtering}Schafer J. B., D. Frankowski, Herlocker J., Sen S. (2007): Collaborative Filtering Recommender Systems. The Adaptive Web, LNCS 4321, 291 - 324, 2007.
 \url{http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.130.4520&rep=rep1&type=pdf}
    
    \bibitem{google_news}Abhinandan D., Mayur D., Ashutosh G., Rajaram S. (2007): Google News Personalization: Scalable Online Collaborative Filtering. ACM 978-1-59593-654-7/07/0005. \url{http://iws.seu.edu.cn/resource/Proceedings/WWW/2007/papers/paper570.pdf}
    
    \bibitem{amazon}Linden G, Smith B., York J.: Amazon.com Recommendations Item-to-Item Collaborative Filtering. IEEE Computer Society 1089-7801/03. \url{http://www.win.tue.nl/~laroyo/2L340/resources/Amazon-Recommendations.pdf}
    
    \bibitem{yahoo} Park S-T., Pennock D. M.: Applying collaborative filtering techniques to movie search for better ranking and browsing. KDD '07 Proceedings of the 13th ACM SIGKDD international conference on Knowledge discovery and data mining, ISBN: 978-1-59593-609-7 \url{http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.90.8109&rep=rep1&type=pdf}
    
    \bibitem{duine}The Duine Recommender Framework. Telematica Instituut/Novay.\url{http://duineframework.org/index.html}
    
    \bibitem{mahout}Overview of Mahout. Apache Software Foundation. \url{https://cwiki.apache.org/confluence/display/MAHOUT/Overview}
    
    \bibitem{survey}Adomavicius G., Tuzhilin A. (2005): Towards the Next Generation of Recommender Systems: A Survey of the State-of-the-Art and Possible Extensions. IEEE Computer Society 1041-4347/05 \url{http://citeseer.ist.psu.edu/viewdoc/download?doi=10.1.1.107.2790&rep=rep1&type=pdf} 
    
    \bibitem{netflix_prize}Bennett J., Lanning S. (2007): The Netflix Prize. ACM 978-1-59593-834-3/07/0008. \url{http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.117.8094&rep=rep1&type=pdf}
    
    \bibitem{netflix_solution} Koren Y. (2009): The BellKor Solution to the Netflix Grand Prize. Netflix prize documentation. \url{http://www.netflixprize.com/assets/GrandPrize2009_BPC_BellKor.pdf}
    
    \bibitem{netflix_benefit} Bell R. M., Koren Y. (2007): Lessons from the Netflix prize challenge. ACM SIGKDD Explorations Newsletter, 10.1145/1345448.1345465. \url{http://www.sigkdd.org/explorations/issues/9-2-2007-12/6-Netflix-1.pdf}
    
    \bibitem{netflix_end}Hunt N. (2010): Netflix Prize Update. Netflix Blog. http://blog.netflix.com/2010/03/this-is-neil-hunt-chief-product-officer.html
    
    \bibitem{google_api}The Google Prediction API. Google. \url{http://code.google.com/apis/predict/}
    
    \bibitem{aura}The Advanced Universal Recommendation Architecture (AURA). Oracle Labs. \url{http://labs.oracle.com/projects/dashboard.php?id=196}
    
    \bibitem{aura_wiki}The AURA project wiki. Oracle Corporation and/or its affiliates.\url{http://kenai.com/projects/aura/pages/Home}
    
    \bibitem{patent}Hueter G. J., Quandt S. C., Hueter N. H. (2009): Universal system and method for representing and predicting human behavior \#20090248599, United States Patent Application Publication, 2009.  \url{http://www.freepatentsonline.com/20090248599.pdf}

    \bibitem{peska}Ladislav Pe¹ka (2010): User preferences in the domain of web shops, Master thesis, Charles University in Prague.
    
    \bibitem{white_paper} Kunegis, J., Said, A., Umbrath, W. (2009): White Paper: The Universal Recommender. 2009arXiv0909.3472K \url{http://adsabs.harvard.edu/abs/2009arXiv0909.3472K}
    
    \bibitem{wiki_genome} Glaser W. T., Westergren T. B., Stearns J. P., Kraft J. M. (2002): Consumer item matching method and system. United States Patent 7003515. \url{http://www.freepatentsonline.com/7003515.pdf}
    
    \bibitem{eckhardt} \textsc{Eckhardt}, Alan, T. Horváth, P. Vojtá¹ (2007): PHASES: A user Profile Learning Aproach for Web Search. WI '07, 780-783. IEEE Computer Society Washington. \url{http://portal.acm.org/citation.cfm?id=1331740.1331829}
