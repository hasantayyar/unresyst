...
\chapter{Introduction}
    ...
    Moderni systemy toho sbiraji o uzivateli, jeho chovani, o prvicich v systemu a vubec, porad vic a tudiz vzrusta potreba kombinovat tuhle business knowledge , na ukor klasickeho kolaborativniho filtrovani, ktere se snazi z jednoho preferencniho zdroje (napr. ratingu), exploitovat co se da. Cim vic dat mam, tim vic se na ne muzu spolehat a nemusim to nechavat na tajemnem algoritmu. 
    
    ze to je trend i ve vyzkumu doklada ta blazniva korenova soutez, http://kddcup.yahoo.com/datasets.php
    ...
    \section{Universal Recommender Analysis}
        ...
        \subsection{Unresyst Process Model Proposal}
            ...
            \subsubsection{Unresyst Maintainance}
                ...
                xxx Decide to collect new data for recommending
                xxx changes in the system that affect recommendation sources, use of newly available data
